...
func TestHandleQuery_MalformedPacket(t *testing.T) {
	...
	err = r.handleQuery(r.transport, malformedPacket, nil, 0)
	if err == nil {
...
func TestHandleQuery_ResponsePacket(t *testing.T) {
	...
	err = r.handleQuery(r.transport, responsePacket, nil, 0)
	if err != nil {
...
func TestHandleQuery_QueryWithNonPTRRecord(t *testing.T) {
	...
	err = r.handleQuery(r.transport, packet, nil, 0)
	if err != nil {
...
func TestHandleQuery_InterfaceSpecificAddressing(t *testing.T) {
	...
	err = r.handleQuery(r.transport, packet, nil, 1)
